...
<html lang="en, ko">
  ...
  <head>
    ...
    <!-- link -->
    <link rel="shortcut icon" href="../../resources/" type="image/x-icon"/>
    ...
    <script defer src="../../resources/jungho/js/daum.js" ></script>
  ...
  <body>
          ...
          <section class="our-blog">
            <div class="container">
              <div class="blog-row row">
                ...
                <!-- item card 1 -->
                <div class="col-auto">
                  <div class="gallery_product col-auto filter 일번">
                    <div class="single-blog">
                      <c:if test="${modelAndView.product_image != null}">
                        <figure class="figure">
                      ...
                      <c:if test="${modelAndView.product_image == null}">
                        <figure class="figure">
                          <img src="../../resources/jungho/images/etc/empty.jpg" />
                        </figure>
                      </c:if>
                ...
                <!-- item card 2 -->
                <div class="col-auto">
                  <div class="gallery_product col-auto filter 이번">
                    <div class="single-blog">
                      <c:if test="${modelAndView.product_image != null}">
                        <figure class="figure">
                          <img src="../../resources/jungho/images/test/2.jpg" />
                        </figure>
                      </c:if>
                      <c:if test="${modelAndView.product_image == null}">
                        <figure class="figure">
                ...
                <!-- item card 3 -->
                <div class="col-auto">
                  <div class="gallery_product col-auto filter 삼번">
                    <div class="single-blog">
                      <c:if test="${modelAndView.product_image != null}">
                        <figure class="figure">
                          <img src="../../resources/jungho/images/test/3.jpg" />
                        </figure>
                      </c:if>
                      <c:if test="${modelAndView.product_image == null}">
                        <figure class="figure">
                ...
                <!-- item card 4 -->
                <div class="col-auto">
                  <div class="gallery_product col-auto filter 사번">
                    <div class="single-blog">
                      <c:if test="${modelAndView.product_image != null}">
                        <figure class="figure">
                          <img src="../../resources/jungho/images/test/4.jpg" />
                        </figure>
                      </c:if>
                      <c:if test="${modelAndView.product_image == null}">
                        <figure class="figure">
                ...
                <!-- item card 5 -->
                <div class="col-auto">
                  <div class="gallery_product col-auto filter hidden">
                    <div class="single-blog">
                      <c:if test="${modelAndView.product_image != null}">
                        <figure class="figure">
                          <img src="../../resources/jungho/images/test/3.jpg" />
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-12">
            <h2> About us </h2>
            <p>
              안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다
            </p>
            <p>
              안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다 안녕하세요 반갑습니다
            </p>
    ...
    <table border="1">
      ...
      <tr>
        <c:forEach items="${modelAndView.shop_product}" var="shop_product">
